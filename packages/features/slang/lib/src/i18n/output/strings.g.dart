...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	late final _StringsSampleJa sample = _StringsSampleJa._(_root);
}

// Path: sample
class _StringsSampleJa {
	_StringsSampleJa._(this._root);
...
class _StringsEn implements Translations {
	...
	// Translations
	@override late final _StringsSampleEn sample = _StringsSampleEn._(_root);
}

// Path: sample
class _StringsSampleEn implements _StringsSampleJa {
	_StringsSampleEn._(this._root);

	@override final _StringsEn _root; // ignore: unused_field

	// Translations
	@override String get title => 'sample';
}
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'sample.title': return 'sample';
			default: return null;
		}
	}
}
